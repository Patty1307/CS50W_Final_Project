...
urlpatterns = [
 ...
 # API Routes
    ...
    path("board/card/delete/<int:card_id>", views.delete_card, name="delete_card"),
    path("task/get/<int:card_id>", views.get_card, name="get_card_data"),
    path("task/update/<int:card_id>", views.update_task, name="update_task"),
]